...
int tree_from_index(ObjectID *id_out)
{
    ...
    while ((entry = readdir(dir)) != NULL) {
        ...
        // Set mode
        e->mode = get_file_mode(entry->d_name);

        // Set name
        strncpy(e->name, entry->d_name, sizeof(e->name));
        ...
        // Store blob
        object_write(OBJ_BLOB, buffer, size, &e->hash);
